...
cd $HOME_DIR/startup/neoload-ci-training && sudo infra/local_jenkins/start.sh $@

cd $HOME_DIR/startup/neoload-ci-training && sudo infra/ubuntu/startup_after_pause.sh
